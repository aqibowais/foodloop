...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    if (success) {
      ...
      AppToast.error(context, state.error ?? 'Login failed');
    }
  }
  ...
  Future<void> _handleGoogleSignIn() async {
    ...
    if (success) {
      ...
      // Wait for auth state to update, then navigate to AuthWrapper
      // This ensures the navigation happens after Firebase auth state is updated
      await Future.delayed(const Duration(milliseconds: 300));
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      SlidePageRoute(child: const SignUpScreen()),
                    );
                  },
                  child: RichText(
                    text: TextSpan(
                      text: "New to FoodLoop? ",
